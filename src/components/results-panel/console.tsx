  ...
  return (
    <div className="p-4 rounded-xl relative flex gap-6 flex-col bg-gray-100">
      <div className="space-y-2">
        <p className="text-neutral-300 mt-4 text-sm font-bold font-mono uppercase">{props.status === "error" ? "Error Message" : "Output"}</p>
      ...
      <div className={`space-y-2 ${props.hasTurtle ? "" : "hidden"}`}>
        <p className="text-neutral-300 mt-4 text-sm font-bold font-mono uppercase">Turtle Graphics</p>
        <div className=" bg-white p-8 rounded-lg relative">
